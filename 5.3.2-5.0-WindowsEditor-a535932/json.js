const json = {
    "devices": [
        {
            ...
            "instance": "DESKTOP-TAT57NG-30608",
    ...
    "reportCreatedOn": "2023.06.27-19.27.54",
    "succeeded": 17,
    "succeededWithWarnings": 0,
    "failed": 1,
    "notRun": 0,
    "inProcess": 0,
    "totalDuration": 74.76951599121094,
    ...
    "tests": [
        {
            ...
            "state": "Fail",
            "deviceInstance": "DESKTOP-TAT57NG-30608",
            "entries": [
                {
                    "event": {
                        "type": "Info",
                ...
                },
                {
                    "event": {
                        "type": "Error",
                        "message": "Project.Functional Tests./GASCompanionTests/FunctionalTests/F_AbilitySets/F_AbilitySets_Level.F_AbilitySets_Level;/GASCompanionTests/FunctionalTests/F_AbilitySets/F_AbilitySets_Level;F_AbilitySets_Test_C_1 will be marked as failing due to errors being logged",
                        "context": "",
                        "artifact": "00000000000000000000000000000000"
                    },
                ...
                },
                {
                    "event": {
                        "type": "Error",
                        "message": "Asset '/GASCompanionTests/FunctionalTests/F_AbilitySets/Abilities/GE_AS_Test_03' has been saved with empty engine version. The asset will be loaded but may be incompatible.",
                        "context": "",
                        "artifact": "00000000000000000000000000000000"
                    },
                    "filename": "D:\\build\\++UE5\\Sync\\Engine\\Source\\Runtime\\CoreUObject\\Private\\UObject\\LinkerLoad.cpp",
